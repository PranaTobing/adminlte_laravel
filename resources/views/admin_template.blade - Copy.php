...
<head>
  ...
  -->
  <link rel="stylesheet" href="{{asset('admin/dist/css/skins/skin-blue.min.css')}}" type="text/css" />
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2017 <a href="#">Prana Tobing</a>.</strong> All rights reserved.
  </footer>
...
<!-- jQuery 2.2.3 -->
<script src="{{asset('js/jquery_3_1_0.min.js')}}"></script>
<!-- Bootstrap 3.3.6 -->
